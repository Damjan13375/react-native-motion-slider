...
const { width: Width = width, height: Height = height } = Dimensions.get(
  "window"
);
  ...
  renderValue() {
    ...
    return (
      ...
      >
        ...
        >
          <View
            style={[Style.valueInnerContainer, this.valueInnerContainerStyle]}
          >
            <Animated.Text
              style={[
                Style.value,
  ...
  render() {
    ...
    return (
      ...
      >
        {this.renderTitle()}
        <Animated.View
          style={[Style.bar, this.barStyle, this.barAnimationStyle()]}
        >
          <Text
            style={[
              Style.min,
